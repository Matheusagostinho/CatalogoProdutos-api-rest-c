    ...
    public partial class Inicial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PedidoDetalhado", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PedidoDetalhado_Pedidos_PedidoId",
                        column: x => x.PedidoId,
                        principalTable: "Pedidos",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PedidoDetalhado_Produtos_ProdutoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PedidoDetalhado_PedidoId",
                table: "PedidoDetalhado",
                column: "PedidoId");

            migrationBuilder.CreateIndex(
                name: "IX_PedidoDetalhado_ProdutoId",
                table: "PedidoDetalhado",
                column: "ProdutoId");
